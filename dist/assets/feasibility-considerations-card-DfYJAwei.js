import{n as l,t as g,G as m,x as o,o as y}from"./icon-badge-Dw_Sbpr1.js";var v=Object.defineProperty,f=Object.getOwnPropertyDescriptor,c=(t,e,a,r)=>{for(var s=r>1?void 0:r?f(e,a):e,i=t.length-1,d;i>=0;i--)(d=t[i])&&(s=(r?d(e,a,s):d(s))||s);return r&&s&&v(e,a,s),s};let p=class extends m{constructor(){super(...arguments),this.tags=[],this.lightBackground=!1}render(){return o`
        ...
        <div class="card mb-5">
          <div class="card-header py-3 bg-primary text-bg-dark">
            <h2 class="fs-5 m-0">${this.heading}</h2>
          </div>
