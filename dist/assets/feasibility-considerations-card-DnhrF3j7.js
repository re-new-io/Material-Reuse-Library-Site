import{n as p,t as m,G as g,x as l,o as y}from"./database-TC6dd-BC.js";var v=Object.defineProperty,u=Object.getOwnPropertyDescriptor,c=(s,e,a,r)=>{for(var t=r>1?void 0:r?u(e,a):e,i=s.length-1,d;i>=0;i--)(d=s[i])&&(t=(r?d(e,a,t):d(t))||t);return r&&t&&v(e,a,t),t};let o=class extends g{constructor(){super(...arguments),this.tags=[],this.lightBackground=!1}render(){return l`
        <h3 class="fs-6 text-uppercase">${this.heading}</h3>
        ${this.tags?.map(s=>l`<span class="badge round-pill rounded-pill fs-6 text-bg-${this.lightBackground?"light border border-primary":"dark"} mt-2 me-2">${s}</span>`)}
        `}};c([p({type:String})],o.prototype,"heading",2);c([p({type:Array})],o.prototype,"tags",2);c([p({type:Boolean})],o.prototype,"lightBackground",2);o=c([m("tags-list")],o);var f=Object.defineProperty,b=Object.getOwnPropertyDescriptor,h=(s,e,a,r)=>{for(var t=r>1?void 0:r?b(e,a):e,i=s.length-1,d;i>=0;i--)(d=s[i])&&(t=(r?d(e,a,t):d(t))||t);return r&&t&&f(e,a,t),t};let n=class extends g{constructor(){super(...arguments),this.metaData=[],this.considerations=[]}render(){return l`
        <div class="card mb-5">
