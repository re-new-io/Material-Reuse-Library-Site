import{n as o,t as v,G as f,x as p,o as S,D as M}from"./icon-badge-BCxSZBFt.js";import"./feasibility-considerations-card-DSgKsElR.js";var ee=Object.defineProperty,te=Object.getOwnPropertyDescriptor,D=(a,r,e,i)=>{for(var t=i>1?void 0:i?te(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ee(r,e,t),t};let C=class extends f{render(){return p`
        ...
        `}};D([o({type:String})],C.prototype,"name",2);D([o({type:String})],C.prototype,"imageUrl",2);D([o({type:String})],C.prototype,"description",2);C=D([v("reuse-option-card")],C);var se=Object.defineProperty,re=Object.getOwnPropertyDescriptor,j=(a,r,e,i)=>{for(var t=i>1?void 0:i?re(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&se(r,e,t),t};let $=class extends f{render(){return p`
        ...
        `}};j([o({type:String})],$.prototype,"name",2);j([o({type:String})],$.prototype,"imageUrl",2);j([o({type:String})],$.prototype,"description",2);$=j([v("component-variety-type-card")],$);var ie=Object.defineProperty,ae=Object.getOwnPropertyDescriptor,x=(a,r,e,i)=>{for(var t=i>1?void 0:i?ae(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ie(r,e,t),t};let u=class extends f{constructor(){super(...arguments),this.includeUnapprovedData=!1}render(){return p`
        <div class="card mb-5">
        ...
        `}};x([o({type:String})],u.prototype,"projectId",2);x([o({type:String})],u.prototype,"name",2);x([o({type:String})],u.prototype,"description",2);x([o({type:String})],u.prototype,"imageUrl",2);x([o({type:String})],u.prototype,"componentId",2);x([o({type:Boolean})],u.prototype,"includeUnapprovedData",2);u=x([v("project-example-card")],u);var ne=Object.defineProperty,de=Object.getOwnPropertyDescriptor,m=(a,r,e,i)=>{for(var t=i>1?void 0:i?de(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ne(r,e,t),t};let g=class extends f{constructor(){super(...arguments),this.isComponent=!0,this.uniclassCodes=[]}render(){return p`
        <div class="card mb-5">
        ...
        `}};R([o({type:String})],L.prototype,"description",2);R([o({type:Array})],L.prototype,"items",2);L=R([v("cost-availability-card")],L);var le=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,V=(a,r,e,i)=>{for(var t=i>1?void 0:i?pe(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&le(r,e,t),t};let I=class extends f{render(){return p`
        <div class="card mb-5">
        ...
        `}};V([o({type:String})],I.prototype,"description",2);I=V([v("environmental-impact-card")],I);var ge=Object.defineProperty,me=Object.getOwnPropertyDescriptor,W=(a,r,e,i)=>{for(var t=i>1?void 0:i?me(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ge(r,e,t),t};let T=class extends f{constructor(){super(...arguments),this.items=[]}render(){return p`
        <div class="card mb-5">
            <div class="card-header py-3 bg-navy text-bg-dark">
        ...
        `}};W([o({type:Array})],T.prototype,"items",2);T=W([v("reclamation-process-card")],T);var ye=Object.defineProperty,he=Object.getOwnPropertyDescriptor,z=(a,r,e,i)=>{for(var t=i>1?void 0:i?he(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ye(r,e,t),t};let N=class extends f{constructor(){super(...arguments),this.items=[]}render(){const a=this.items?.filter(r=>r);return p`
        <div class="card mb-5">
            <div class="card-header py-3 bg-secondary text-bg-dark">
        ...
        `}};z([o({type:Array})],N.prototype,"items",2);N=z([v("features-suitability-card")],N);var ue=Object.defineProperty,ve=Object.getOwnPropertyDescriptor,O=(a,r,e,i)=>{for(var t=i>1?void 0:i?ve(r,e):r,n=a.length-1,s;n>=0;n--)(s=a[n])&&(t=(i?s(r,e,t):s(t))||t);return i&&t&&ue(r,e,t),t};let w=class extends f{render(){return p`
        <div class="card mb-5">
            <div class="card-header py-3 bg-primary text-bg-dark">
